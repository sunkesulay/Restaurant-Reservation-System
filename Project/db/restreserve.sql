...
--
-- Database: `restreserve`
--

-- --------------------------------------------------------

--
-- Table structure for table `high_traffic_days`
--

CREATE TABLE `high_traffic_days` (
  `day` date NOT NULL,
  `hold_fee_required` tinyint(1) NOT NULL DEFAULT 0,
...
CREATE TABLE `reservations` (
  ...
  `is_guest_user` tinyint(1) NOT NULL DEFAULT 0,
  `requires_credit_card` tinyint(1) NOT NULL DEFAULT 0,
  `no_show_charge` decimal(10,2) DEFAULT 0.00,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `users` (
  ...
  `preferred_diner_number` varchar(20) DEFAULT NULL,
...
--
-- Indexes for table `high_traffic_days`
--
ALTER TABLE `high_traffic_days`
  ADD PRIMARY KEY (`day`);
